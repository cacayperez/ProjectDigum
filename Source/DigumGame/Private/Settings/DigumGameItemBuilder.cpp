...
#include "Settings/DigumGameItemBuilder.h"
...
bool UDigumGameItemBuilder::BuildItemProperties(const FDigumItemProperties& InItemProperties, UDigumItem*& OutBuiltItem)
{
